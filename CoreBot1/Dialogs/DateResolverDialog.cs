...
namespace CoreBot1.Dialogs
{
    ...
    {
        private const string PromptMsgText = "Bạn muốn đặt vé khi nào?";
        private const string RepromptMsgText = "Xin lỗi, để đặt vé vui lòng bạn hãy nhập ngày đầy đủ bao gồm cả tháng và năm!";
